...
Before the HGP, genetics meant studying one gene at a time. Researchers would spend years isolating and characterizing a single gene. After the HGP, scientists could look at all genes simultaneously. To determine which genes are active in cancer cells versus normal cells, researchers can now compare the expression of all 20,000 genes simultaneously. This shift from individual genes to whole-genome analysis opened entirely new research approaches.
