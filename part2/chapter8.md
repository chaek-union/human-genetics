...
- Radical changes (charged â†” hydrophobic) often harmful
...
- âœ“ Nonsense or frameshift in disease-relevant gene
- âœ“ Rare (<0.01%) or absent in population databases
- âœ“ High constraint gene (pLI >0.9)
- âœ“ Segregates with disease in family
- âœ“ Matches known inheritance pattern
- âœ“ Functional studies confirm effect
...
**Likely benign:**
- âœ— Common in population (>1%)
- âœ— Synonymous in non-splice region
- âœ— Multiple computational predictions: benign
- âœ— Seen in healthy individuals with same phenotype
